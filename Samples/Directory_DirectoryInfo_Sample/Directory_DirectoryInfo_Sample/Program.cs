    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                // O SearchOption.AllDirectories permite que seja realizada também uma busca dentro das possíveis subpastas nesse diretório. Assim, também vai ser listado arquivos de subpastas.
